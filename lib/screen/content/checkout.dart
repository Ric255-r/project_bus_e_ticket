    ...
    try {
      ...
      if (mode == "cash") {
        ...
        MultipartFile multipartFile =
            await MultipartFile.fromFile(_imgFile!.path, filename: fileName);
            ...
            actions: [
              TextButton(
                  onPressed: () async {
                    ...
                    var jwt = await getStoredJwt();
                    Map<String, dynamic> data = {"usernya": await getMyData(jwt)};
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [Expanded(child: Text("Total Tagihan"))],
                    ),
                    Row(
                      children: [
                        Expanded(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Expanded(flex: 3, child: Text("Bank Transfer")),
                        SizedBox(
                            //buat radio
                            width: 40,
                            // height: 40,
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Expanded(flex: 3, child: Text("Cash")),
                        SizedBox(
                            //buat radio
                            width: 40,
                            // height: 40,
